...
<body>
    ...
    <div class="comprobante">
        ...
        <div class="comprobante-titulo">
            ...
            <div class="comprobante-numero">N° {{ $venta->id_venta }}</div>
        </div>
        <div class="content">
            <div class="info-section">
                <h3>Detalle de la Venta</h3>
                <table class="info-grid">
                    <tr class="info-row"><td class="info-label">Artículo:</td><td class="info-value">{{ $venta->articulo }}</td></tr>
                    <tr class="info-row"><td class="info-label">Fecha:</td><td class="info-value">{{ $venta->fecha }}</td></tr>
                    <tr class="info-row"><td class="info-label">Monto:</td><td class="info-value monto">${{ number_format($venta->monto, 2, '.', ',') }}</td></tr>
                </table>
            </div>
        </div>
        <div class="footer">
