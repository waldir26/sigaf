...
<body>
    ...
    <div class="comprobante">
        ...
        <div class="comprobante-titulo">
            ...
            <div class="comprobante-numero">N° {{ $servicio->id_servicio }}</div>
        </div>
            ...
            <div class="info-section">
                ...
                <table class="info-grid">
                    <tr class="info-row">
                        ...
                        <td class="info-value">{{ $servicio->tipo_servicio }}</td>
                    </tr>
                    <tr class="info-row">
                        <td class="info-label">Fecha:</td>
                        <td class="info-value">{{ $servicio->fecha }}</td>
                    </tr>
                    <tr class="info-row">
                        <td class="info-label">Responsable:</td>
                        <td class="info-value">{{ $servicio->responsable ?? 'N/A' }}</td>
                    </tr>
                    <tr class="info-row">
                        <td class="info-label">Monto:</td>
                        <td class="info-value monto">${{ number_format($servicio->monto, 2, '.', ',') }}</td>
                    </tr>
                    @if($servicio->descripcion)
                    <tr class="info-row">
                        <td class="info-label">Descripción:</td>
                        <td class="info-value">{{ $servicio->descripcion }}</td>
                    </tr>
                    @endif
                </table>
            </div>
