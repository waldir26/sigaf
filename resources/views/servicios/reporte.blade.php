    ...
    <div class="reporte">
        ...
        <div class="resumen">
            <div class="resumen-card">
                ...
                <div class="valor">{{ $servicios->count() }}</div>
            </div>
            <div class="resumen-card">
            ...
            <table class="tabla">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><strong>${{ number_format($servicio->monto, 2, '.', ',') }}</strong></td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="5" style="text-align: center;">No hay servicios registrados</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
